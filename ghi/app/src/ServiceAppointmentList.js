...
{/* Filtered appointments */}
            {vinResult.length > 0 ? (vinResult.map(appointment => (
              <tr key={appointment.vin}>
                ...
                <td>
                  <button type="button" className="btn btn-danger" onClick={() => handleCancel(appointment)}>Cancel</button>
                </td>
                <td>
                  <button type="button" className="btn btn-success" onClick={() => handleFinish(appointment)}>Finish</button>
                </td>
              </tr>
              ))
              ) : (
